...
@interface KWEPopoverContainerView()
...
@interface KWEPopoverContainerView(Private)
...
- (CGRect)contentRect;
- (CGSize)contentSize;
- (void)setProperties:(KWEPopoverContainerViewProperties *)props;
- (void)initFrame;
- (CGFloat)shadowInset;

@end

@implementation KWEPopoverContainerView {
    UIImage *_bgImage;
    UIImage *_arrowImage;
    
    KWEPopoverContainerViewProperties *_properties;
...
permittedArrowDirections:(UIPopoverArrowDirection)permittedArrowDirections
        properties:(KWEPopoverContainerViewProperties *)theProperties {
    if ((self = [super initWithFrame:CGRectZero])) {
        ...
        self.bgView.backgroundColor = [UIColor clearColor];//_properties.backgroundColor == nil ? [UIColor clearColor] : _properties.backgroundColor;
...
@implementation KWEPopoverContainerView(Private)
...
- (void)initFrame {
    ...
    //If arrow rect origin is < 0 the frame above is extended to include it so KWE should offset the other rects
