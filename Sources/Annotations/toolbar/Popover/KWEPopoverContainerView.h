...
@class KWEPopoverContainerView;

@protocol KWEPopoverContainerViewDelegate <NSObject>

/**
 Implement to override the frame being set in setFrame:
 */
- (CGRect)popoverContainerView:(KWEPopoverContainerView *)view willChangeFrame:(CGRect)newFrame;
 ...
 */
@interface KWEPopoverContainerView : UIView

@property (nonatomic, weak) id <KWEPopoverContainerViewDelegate> delegate;
...
permittedArrowDirections:(UIPopoverArrowDirection)permittedArrowDirections
		properties:(KWEPopoverContainerViewProperties *)properties;
