...
#import "KWETouchableView.h"
#import "KWEPopoverContainerView.h"

/**
 Notifications for showing/dismissing.
 */
extern NSString * const KWEPopoverControllerWillShowNotification;
extern NSString * const KWEPopoverControllerDidDismissNotification;

@class KWEPopoverController;

/**
 Delegate for popover events.
 */
@protocol KWEPopoverControllerDelegate<NSObject>
 ...
 */
- (void)popoverControllerDidDismissPopover:(KWEPopoverController *)popoverController;

/**
 Return YES to allow dismissal of the popover (default), NO otherwise.
 */
- (BOOL)popoverControllerShouldDismissPopover:(KWEPopoverController *)popoverController;
 ...
 */
- (void)popoverController:(KWEPopoverController *)popoverController willRepositionPopoverToRect:(inout CGRect *)rect inView:(inout UIView **)view;
 ...
 */
- (CGRect)displayAreaForPopoverController:(KWEPopoverController *)popoverController relativeToView:(UIView *)parentView;
 ...
 */
- (CGRect)backgroundAreaForPopoverController:(KWEPopoverController *)popoverController relativeToView:(UIView *)parentView;
 ...
 */
- (UIView *)backgroundViewForPopoverController:(KWEPopoverController *)popoverController;
 ...
 */
- (CGSize)preferredContentSizeForPopoverController:(KWEPopoverController *)popoverController withConstraintSize:(CGSize)constraintSize;
 ...
 */
typedef NS_ENUM(NSUInteger, KWEPopoverAnimationType) {
    KWEPopoverAnimationTypeCrossFade = 0,
    KWEPopoverAnimationTypeSlide = 1
};

typedef NS_ENUM(NSUInteger, KWEPopoverTransitionType) {
    KWEPopoverTransitionTypePresent = 0,
    KWEPopoverTransitionTypeDismiss,
    KWEPopoverTransitionTypeReposition
};

/**
 Completion block definition.
 */
typedef void(^KWEPopoverCompletionBlock)(void);

/**
 Transition block definition.
 */
typedef void(^KWEPopoverTransitionBlock)(KWEPopoverTransitionType transitionType, BOOL animated);
 ...
 */
@interface KWEPopoverController : NSObject
...
/**
 The delegate.
 */
@property (nonatomic, weak) id <KWEPopoverControllerDelegate> delegate;
 ...
 */
@property (nonatomic, strong) KWEPopoverContainerViewProperties *containerViewProperties;
...
/**
 ...
 Default is KWEPopoverAnimationTypeCrossFade
 */
@property (nonatomic, assign) KWEPopoverAnimationType animationType;
...
/**
 Animation duration for sliding in the arrow for animation type KWEPopoverAnimationTypeSlide. Is not used for animation type KWEPopoverAnimationTypeCrossFade.
 ...
 */
@property (nonatomic, copy) KWEPopoverTransitionBlock transitionBlock;
 ...
 */
@property (nonatomic, copy) KWEPopoverCompletionBlock afterDismissBlock;

/**
 The UIView subclass to use for the backgroundView.fillView of the popover. This is the view that is tinted in the background when the popover is visible.
 ...
 * The background view.
 *
 * The fillView property of this view is set using backgroundViewClass or backgroundViewForPopoverController: if implemented by the delegate.
 */
@property (nonatomic, strong, readonly) KWETouchableView *backgroundView;

/**
 * The container view for the popover.
 */
@property (nonatomic, strong, readonly) KWEPopoverContainerView *containerView;

/**
 The default container view properties to be used by the popover.
 */
+ (KWEPopoverContainerViewProperties *)defaultContainerViewProperties;
+ (void)setDefaultContainerViewProperties:(KWEPopoverContainerViewProperties *)properties;

/**
 Returns true iff any instance of KWEPopoverController is visible.
 */
+ (BOOL)isAnyPopoverVisible;

/**
 Returns the array of visible KWEPopoverControllers.
 */
 ...
 */
- (void)dismissPopoverAnimated:(BOOL)animated completion:(KWEPopoverCompletionBlock)completion;
...
/**
 ...
 If the popover is transitioning, this method does nothing. Use waitUntilNotTransitioning if you want to present after any transition was finished.
 */
- (void)presentPopoverFromRect:(CGRect)rect
                        inView:(UIView *)view
      permittedArrowDirections:(UIPopoverArrowDirection)arrowDirections
                      animated:(BOOL)animated
                    completion:(KWEPopoverCompletionBlock)completion;

/**
 Presents the popover from the specified bar button item and alloKWEd arrow directions, optionally animating the presentation.
...
/**
 ...
 This method has no effect if the popover hasn't been presented yet or is transitioning.
 */
