...
@interface KWETouchableView()

@property (nonatomic, strong) KWEBlockingGestureRecognizer *blockingGestureRecognizer;

@end

@interface KWETouchableView(Private)

- (BOOL)isPassthroughView:(UIView *)v;

@end

@implementation KWETouchableView {
    BOOL _testHits;
...
- (id)initWithFrame:(CGRect)frame {
    if ((self = [super initWithFrame:frame])) {
        KWEBlockingGestureRecognizer *gr = [[KWEBlockingGestureRecognizer alloc] init];
...
@implementation KWETouchableView(Private)
